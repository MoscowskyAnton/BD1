...
from bd1_gazebo_env_interface import bd1_gazebo_gym_goal_env_wrapper
from stable_baselines3.common.callbacks import BaseCallback, CheckpointCallback, CallbackList
from stable_baselines3.common.results_plotter import load_results, ts2xy
from stable_baselines3.common.monitor import Monitor
from stable_baselines3.common.noise import OrnsteinUhlenbeckActionNoise, NormalActionNoise

class GoalStableBaselines3Trainer(object):
    def __init__(self):
        rospy.init_node('goal_stable_baselines3_trainer')
        ...
        if self.load_path is None:
            if self.algorithm == 'ppo':
                ...
                self.model = sb3.SAC(self.policy, 
                                    ...
                                    replay_buffer_class=sb3.HerReplayBuffer,
                                    replay_buffer_kwargs=dict(
                                        n_sampled_goal=4,
                                        goal_selection_strategy='future',
                                        online_sampling=True,
                                        max_episode_length=self.max_episode_timesteps,),
                                    )
...
if __name__ == '__main__' :
    gsbl3t = GoalStableBaselines3Trainer()
    gsbl3t.run()
